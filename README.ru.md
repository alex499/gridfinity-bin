...
- `split_lid` режет крышку по перегородкам между ячейками, по куску на ячейку, так что
  ...
  куска так же, как стенка держит их наружные кромки: паз глубиной 0.8 мм на каждой грани,
  фаски 45° на входе и выходе, чтобы ни одно нависание не требовало поддержек, и верх вровень
  с бортом. Канавку, которую верхняя фаска оставила бы вдоль шва, закрывает сама крышка:
  кусок ведёт плавник под шапку под тем же углом, а это верхняя грань детали, лежащей плашмя,
  так что нависаний тоже не прибавляется. Резать можно только по перегородке, идущей на всю
  глубину бина, поэтому нужен один ряд ячеек
