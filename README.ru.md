...
- `split_lid` режет крышку по перегородкам между ячейками, по куску на ячейку, так что
  ...
  так что закрытая крышка выходит плоской — над ней от рельса ничего не торчит. Резать можно
  только по перегородке, идущей на всю глубину бина, поэтому нужен один ряд ячеек
