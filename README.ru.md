...
| С перегородками, крышка снята: два ряда по две и по три ячейки, у каждого ряда свой scoop от перегородки перед ним. Вырез в передней стенке — рот, через который заходит крышка. | Без перегородок, поэтому тот же паз держит карточку-лейбл, а передняя стенка остаётся целой. |
