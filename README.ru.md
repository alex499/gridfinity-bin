...
0.8 мм, здесь — 1.2, и высота паза вообще не измеренное число: это `plate_thickness +
plate_play`, так что пластина влезает всегда, а оставшиеся 0.2 мм — ровно тот ход, на который
она может всплыть, прежде чем её поймает конус бортика. Поэтому карточка 1x1 выходит
39.1 × 15 × 1.2 вместо 37.4 × 11.95 × 0.8: больше места под надпись и никакой
взаимозаменяемости с карточками той модели.
