...
- `split_lid` режет крышку по перегородкам между ячейками, по куску на ячейку, так что
  ...
  тот же рот и несёт свою долю язычка. Перегородка под швом доходит до уровня полки и
  расширяется под 45° в площадку, на которую ложится по 0.8 мм каждого из двух кусков, а сами
  куски сходятся над ней встык с зазором, так что сверху крышка остаётся сплошной. Резать
...
- Перегородки по свободной сетке: `rows` задаёт число ячеек в каждом ряду, и ряды могут
  ...
  переход на крышку. Те, что делят
  ряды, несут на задней грани тот же scoop, что и передняя стенка, так что каждый ряд —
  маленький бин со своим scoop'ом; радиус ограничен глубиной ряда.
