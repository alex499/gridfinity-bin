...
numbers taken from the ultra-light bin's actual profile.

## What is implemented

- Outer shell sized to the Gridfinity grid (42 mm pitch, 7 mm height unit) with rounded corners
...
- Hollow feet, so the cavity extends down into the base and only a thin bottom skin
  remains — the "ultra light, no magnets" approach
